...
public class BooleanSelectorBlockFactory extends BlockFactory {
	...
	protected void addWireNodes(Map<String, WireNode> wireNodes) {
		...
		wireNodes.put(INPUT_KEY_2,
				new WireNode(INPUT_KEY_2, WireNodeType.INPUT, DataType.BOOLEAN, new Point(32.5, 3.5)));
		wireNodes.put(INPUT_KEY_3,
				new WireNode(INPUT_KEY_3, WireNodeType.INPUT, DataType.BOOLEAN, new Point(48.5, 3.5)));
